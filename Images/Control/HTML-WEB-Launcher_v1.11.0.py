...
def enforce_single_instance():
    ...
    try:
        ...
        temp_root = tk.Tk()
        temp_root.withdraw()
        messagebox.showinfo("Already Running", "An instance of HTML-WEB-Launcher is already open.")
        temp_root.destroy()
        sys.exit(0)
...
class LauncherApp:
    def __init__(self, root):
        self.root = root
        self.root.title("HTML-WEB-Launcher")
    ...
    def refresh_buttons(self):
        ...
        if not os.path.exists(PATHS_FILE):
            try:
                with open(PATHS_FILE, "w") as f:
                    ...
                    f.write("# Example Web Link: https://github.com\n")
        ...
        for index, path in enumerate(valid_paths):
            ...
            # Formatting Display Name and Colors (Web = Blue, Local = Green)
            if is_web:
                display_name = extract_site_name(path)
    ...
    def show_help(self):
        ...
        # Bumped height slightly to accommodate the new color code text
        help_w = rem(26)  
        help_h = rem(38)  
        ...
        help_text.insert("end", "How to Use this HTML WEB Launcher App\n\n", "title")
        ...
        help_text.insert("end", "3. Paste the exact, full path to your .html file or web link on a new line.\n\n")
        
        help_text.insert("end", "   Example (Windows):\n", "bold")
        help_text.insert("end", "   C:\\Users\\Name\\Documents\\MyProject\\index.html\n\n")
        
        help_text.insert("end", "   Example (Mac/Linux):\n", "bold")
        help_text.insert("end", "   /Users/Name/Documents\\MyProject/index.html\n\n")
        
        help_text.insert("end", "   Example (Web Link):\n", "bold")
        help_text.insert("end", "   https://github.com\n\n")
        
        help_text.insert("end", "4. Save the text file and close it.\n")
        
        help_text.insert("end", "5. Click ")
        help_text.insert("end", "'🔄 Refresh'", "bold")
        help_text.insert("end", " in the app to load your new buttons.\n")
        
        help_text.insert("end", "6. Click any ▶ button to launch the project in your browser.\n\n")
        ...
        help_text.insert("end", "• Local Folders ", "bold")
        help_text.insert("end", "appear in ")
        help_text.insert("end", "Green.\n\n", "green")
        
        help_text.insert("end", "NOTE: ", "bold")
        help_text.insert("end", "This app allows a maximum of 20 projects at a time.\n\n")
